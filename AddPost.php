    ...
    <div class="img-form">
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
          ...
          <input type="file" name="post" accept="image/*" required>
      		<button type="submit" name="Addpost" class="upload-button"> Upload </button>
      </form>
    </div>
  </div>
</div>
...
if(isset($_POST['Addpost'])){
    ...
    $sql = "INSERT INTO post (post_img,PostUserId,user_Profile,post_DateTime) VALUES  ('{$file_name}','{$UserId}','{$userP}','{$date}');";
