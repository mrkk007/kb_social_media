          ...
          <ul class="list-unstyled">
            ...
            <li>
              ...
              <div class="btn-group-vertical btn-block">
                <a href="EditProfile.php" class="btn btn-default"><i class="fa fa-cog pull-right"></i>Edit Account</a>
...
<div class="tab-content">
  ...
  <div class="tab-pane animated active fadeInRight" id="my-timeline">
    <div class="user-profile-content">
      <div class="row flex">
        <a class="col-sm-6 col-lg-4 col-md-4 btn btn-primary" href="AddPost.php">Add Post</a>
      </div>
      <div class="row">
        <?php
          $UserPost = dbSelectTableData("post","*","PostUserId = '{$userId}'");
          if(mysqli_num_rows($UserPost) > 0){
            while ($row = mysqli_fetch_assoc($UserPost)) {
        ?>
          <div href="#" class="col-sm-6 col-lg-4  col-md-4 post_img">
            <div class="post_hover">
              <a href="#"><i class="fa fa-heart"></i> <?php echo $row['p_like']; ?></a>
              <a href="DeletePost.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-trash"></i></a>
            </div>
            <img src="./Images/<?php echo $row['post_img']; ?>" width="100%" height="250px" alt="" class="img-fluid rounded shadow-sm">
          </div>
        <?php
            }
          }
    ...
    <div class="user-profile-content">
      ...
      <div class="profile">
        ...
        <?php
          ...
          <a class="profile__button" href="RemoveFriend.php?UserName=<?php echo $fr['User_name']; ?>&FrId=<?php echo $UserFrId; ?>">UnFriend</a>
        </div>
  		  </div>
  		</div>
